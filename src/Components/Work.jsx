  ...
  return (
    <div className='relative max-w-screen-xl mx-auto pt-10'>
        ...
        <div className='absolute w-full h-full top-0'>
            {images.map((elem,index)=>elem.isActive && <img className='absolute -translate-x-[50%] -tanslate-y-[50%] rounded-lg w-60' src={elem.url} style={{top:elem.top, left:elem.left}} alt="" />)}
        </div>
    </div>
  )
}
